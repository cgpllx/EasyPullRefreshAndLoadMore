...
public class DefaultRefreshHeader extends FrameLayout implements PtrUIHandler {
    ...
    @Override
    public void onUIReset(PullRefreshFrameLayout frame) {
        resetView();
    ...
    @Override
    public void onUIRefreshPrepare(PullRefreshFrameLayout frame) {
    ...
    @Override
    public void onUIRefreshBegin(PullRefreshFrameLayout frame) {
    ...
    @Override
    public void onUIRefreshComplete(PullRefreshFrameLayout frame) {
    ...
    @Override
    public void onUIPositionChange(PullRefreshFrameLayout frame, boolean isUnderTouch, byte status, PtrIndicator ptrIndicator) {
        ...
        if (currentPos < mOffsetToRefresh && lastPos >= mOffsetToRefresh) {
            if (isUnderTouch && status == PullRefreshFrameLayout.PTR_STATUS_PREPARE) {
    ...
    private void crossRotateLineFromTopUnderTouch(PullRefreshFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
    ...
    private void crossRotateLineFromBottomUnderTouch(PullRefreshFrameLayout frame) {
        mTitleTextView.setVisibility(VISIBLE);
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.cube_ptr_pull_down_to_refresh));
        } else {
